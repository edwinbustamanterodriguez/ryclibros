...
describe('Component Tests', () => {
  describe('Devolucion Management Component', () => {
    let comp: DevolucionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DevolucionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.devolucions?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
