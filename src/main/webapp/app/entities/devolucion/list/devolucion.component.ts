...
export class DevolucionComponent implements OnInit {
  ...
  trackId(index: number, item: IDevolucion): number {
    return item.id!;
  }

  delete(devolucion: IDevolucion): void {
    const modalRef = this.modalService.open(DevolucionDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IDevolucion[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
