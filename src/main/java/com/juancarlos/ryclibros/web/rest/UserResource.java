...
import com.juancarlos.ryclibros.web.rest.errors.EmailAlreadyUsedException;
import com.juancarlos.ryclibros.web.rest.errors.LoginAlreadyUsedException;
import java.net.URI;
...
public class UserResource {
     ...
     */
    @PostMapping("/users")
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.ADMINISTRADOR + "\")")
