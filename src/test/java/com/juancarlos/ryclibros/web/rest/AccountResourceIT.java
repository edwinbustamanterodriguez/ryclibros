...
import static com.juancarlos.ryclibros.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.juancarlos.ryclibros.IntegrationTest;
import com.juancarlos.ryclibros.config.Constants;
import com.juancarlos.ryclibros.domain.User;
import com.juancarlos.ryclibros.repository.AuthorityRepository;
import com.juancarlos.ryclibros.repository.UserRepository;
import com.juancarlos.ryclibros.security.AuthoritiesConstants;
import com.juancarlos.ryclibros.service.UserService;
import com.juancarlos.ryclibros.service.dto.AdminUserDTO;
import com.juancarlos.ryclibros.service.dto.PasswordChangeDTO;
import com.juancarlos.ryclibros.web.rest.vm.KeyAndPasswordVM;
import com.juancarlos.ryclibros.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testGetExistingAccount() throws Exception {
        ...
        authorities.add(AuthoritiesConstants.ADMINISTRADOR);
        ...
        restAccountMockMvc
            ...
            .andExpect(jsonPath("$.authorities").value(AuthoritiesConstants.ADMINISTRADOR));
    }
    ...
    void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.ARCHIVO));
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.ARCHIVO));
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.ARCHIVO));
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.ADMINISTRADOR));
        ...
        assertThat(userDup.get().getAuthorities())
            .hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.ARCHIVO).get());
    }
    ...
    void testSaveAccount() throws Exception {
        ...
        userDTO.setAuthorities(Collections.singleton(AuthoritiesConstants.ADMINISTRADOR));
